...
class train:
  annotation_path = os.path.join(ROOT_DIR, "./data/remote_car/train.json")  # Path to the annotation file
  ...
  steps = 3000                      # Number of steps for which to train model
  max_steps = None                   # Number of total steps for which to train model
  save_checkpoints_steps = 100      # Number of training steps when checkpoint should be saved
...
class eval:
  annotation_path = {
    "train": os.path.join(ROOT_DIR, "./data/remote_car/train.json"),
    "test": os.path.join(ROOT_DIR, "./data/remote_car/train.json")
